/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e928f3818ae0868dfb435d5090beec81)
// Runtime types generated with workerd@1.20251210.0 2024-06-05 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SponsorManagement";
	}
	interface Env {
		SPONSOR_PRIVATE_KEY: string;
		SPONSOR_PRIVATE_KEY_CSV: string;
		DEV: string;
		DAO_DEPLOYER: string;
		SPONSOR_MANAGEMENT: DurableObjectNamespace<import("./src/index").SponsorManagement>;
	}
}
